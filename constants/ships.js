...
export const CREATE_SHIP_RESET = "CREATE_SHIP_RESET";
...
export const LIST_SHIPS_REQUEST = "LIST_SHIPS_REQUEST";
export const LIST_SHIPS_SUCCESS = "LIST_SHIPS_SUCCESS";
export const LIST_SHIPS_FAILURE = "LIST_SHIPS_FAILURE";
